...
export default function UpdatePostingAccountModule({ config }) {
  ...
  return (
    <ErpLayout>
      {isSuccess ? <UpdateItem config={config} UpdateForm={PostingAccountForm} /> : <NotFound entity={config.entity} />}
    </ErpLayout>
  );
}
