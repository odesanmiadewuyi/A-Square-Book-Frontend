...
export default function UpdateGLAccountGroupModule({ config }) {
  ...
  return (
    <ErpLayout>
      {isSuccess ? <UpdateItem config={config} UpdateForm={GLAccountGroupForm} /> : <NotFound entity={config.entity} />}
    </ErpLayout>
  );
}
