...
export default function UpdateGLAccountSubGroupModule({ config }) {
  ...
  return (
    <ErpLayout>
      {isSuccess ? <UpdateItem config={config} UpdateForm={GLAccountSubGroupForm} /> : <NotFound entity={config.entity} />}
    </ErpLayout>
  );
}
