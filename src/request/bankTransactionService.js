...
// Create a BankTransaction entry
// Fields: number?, date, period?, source, description, status, currency,
// postingcode, tellerorchequeno, Debit, Credit
export async function createBankTransactionEntry(data) {
  const payload = { ...data };
  ...
  return request.create({ entity: 'banktransaction', jsonData: payload });
}
