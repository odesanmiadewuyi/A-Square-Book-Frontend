...
import { CreateProductCategoryModule } from '@/modules/ProductCategoryModule';
...
export default function ProductCategoryCreate() {
  ...
  const config = { entity, ...Labels, hideViewReport: true };
  return <CreateProductCategoryModule config={config} />;
}
